...
- Candidates CSV: `outputs/tables/enriched/scienceon_recovery_R003_exhaustion_candidates.csv`
- Skipped CSV: `outputs/tables/enriched/scienceon_recovery_R003_exhaustion_skipped.csv`
