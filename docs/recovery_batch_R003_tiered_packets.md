...
| ------------ | ---------------------------------- | ---- | ----------------- | ---------------- | --------------------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1            | tier_4_manual_metadata_has_context | 100  | 1                 | 100              | Use existing context plus DOI/index metadata. | jstor_or_legacy_doi   | outputs/tables/enriched/recovery_batch_R003_tiered_packets/recovery_batch_R001_tier_01_tier_4_manual_metadata_has_context.csv | data/intermediate/insufficient_text_recovery_review_forms/R003/tiered/recovery_batch_R001_tier_01_tier_4_manual_metadata_has_context.html | Fill abstract/source provenance, export CSV to the tiered review exports directory, run recovery tiered staging, then run recovery split preflight on the staged split summary. |
